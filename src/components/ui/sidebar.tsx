  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "hidden lg:flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground border-r",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] ease-in-out lg:flex",
             "w-[--sidebar-width]",
            side === "left"
